...
let project = "FSharp.CommandLine"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "A framework for building command line application in F#"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "A framework for building command line application in F#. Supports command line option parsing, type-safe scanf, monadic command construction, automatic help & shell completion generation, and so on."

// List of author names (for NuGet package)
let authors = [ "cannorin" ]

// Tags for your project (for NuGet package)
let tags = "fsharp commandline parsing framework"

// File system information
let solutionFile  = "FSharp.CommandLine.sln"
...
let gitOwner = "cannorin"
let gitHome = sprintf "%s/%s" "https://github.com" gitOwner

// The name of the project on GitHub
let gitName = "FSharp.CommandLine"

// The url for the raw files hosted
let gitRaw = environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/cannorin"
